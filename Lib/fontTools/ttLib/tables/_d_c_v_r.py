...
class table__d_c_v_r(DefaultTable.DefaultTable):
	dependencies = ["dcva", "glyf"]
	...
	def compile(self, ttFont):
		axisTags = [axis.axisNameID for glyphAxisCollection in ttFont["dcva"].glyphAxisCollections
					for axis in glyphAxisCollection.axes]
	...
	def compileGlyphs_(self, ttFont, axisTags, sharedCoordIndices):
		...
		for glyphName in ttFont.getGlyphOrder():
			...
			# 	for vg in glyph.variationGlyphs:
					# print("dcvr", glyphName, vg, '\n')
		return result
